#include"LaserStartEffect.h"

void C_LaserStartEffect::Init(Math::Vector2 pos)
{
	//座標代入
	m_pos = pos;
	m_scale = 1.5f;
...
void C_LaserStartEffect::Update()
{
...
void C_LaserStartEffect::Release()
{
